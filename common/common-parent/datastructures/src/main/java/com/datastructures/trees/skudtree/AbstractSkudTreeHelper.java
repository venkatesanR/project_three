...
abstract public class AbstractSkudTreeHelper {
    ...
    final protected void clearLeafNodesVisited() {
        _leafNodesVisited.clear();
    }

    final protected void onVisit(SkudTreeLeafNode aLeafNode) {
        _leafNodesVisited.add(aLeafNode);
    }
    ...
    protected List<SkudTreeLeafNode> sort(List<SkudTreeLeafNode> nodes) {
        Collections.sort(nodes, new Comparator<Object>() {
            public int compare(Object o1, Object o2) {
                ...
                // when the weighted score is the same, the leaf node decides the order (leafNode in this case should
                // be a subclass of Comparable
                Object value1 = node1.getLeafNodeData();
                // if the leaf node date is a Double or string or any class implemening the Comparable, then further
                // sort it
     ...
     * @param previousLeafNode      - the SkudTreeLeafNode that was just replaced by newLeafNode.
     */
    abstract public void onPutLeafNodeReplace(SkudTreeLeafNode newLeafNode, Object applicationDataObject,
