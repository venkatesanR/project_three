...
import com.techmania.common.util.collectionutil.StrUtl;
...
public class OkudTreeLevel implements java.io.Serializable {
    ...
    /**
     * If true, external cache will be used to store this level down until a lower level flag is true and cache
     * management is
    ...
    protected OkudTreeLevel(String name, String type) {
        if (StrUtl.isEmptyTrimmed(name)) {
            throw new IllegalArgumentException("OkudTree level name cannot be empty or null");
        }
        _name = name;
        _levelType = type;
    }
    ...
    public boolean equals(Object o) {
        if (o == null || !(o instanceof OkudTreeLevel)) {
            return false;
        }
