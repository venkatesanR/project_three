...
public class TestSkudTree {
    public static void main(String[] args) {
        ...
        SkudTree myTree = new SkudTree.SkudTreeBuilder()
                .setLevel(Stream.of(myLevels).collect(Collectors.toList()))
                .setEnforceSerializable(true)
                .setEnforcedApplicationDataObjectInstance(new MyBaseDataObject("Example"))
                .setWildCardKey("ANY")
                .build();
...
class MyBaseDataObject implements java.io.Serializable {
    public MyBaseDataObject(String s) {
        _str = s;
    }
    ...
    public String toString() {
        return System.getProperty("line.separator") + "MyBaseDataObject[ str=" + _str + "]";
    }
}

class MyDerivedDataObject extends MyBaseDataObject {
    public MyDerivedDataObject(String s) {
        super(s);
    }

    public String toString() {
        return System.getProperty("line.separator") + "MyDerivedDataObject[ " + super.toString() + "\n" +
                "]MyDerivedDataObject";
    }
}
