...
public interface IExternalCache {
	...
	/**
	 * Must release the write lock after modification (usually in a finally
	 * block)
	 * 
	 * @param cacheName
	 * @param key
	...
	/**
	 * Retrieve all cached elements and return the named cache Note that this
	...
	/**
	 * Returns the size of the cache (in memory + off memory) Note that this
	 * could be an expensive operation
	 * 
	 * @param cacheName
	 * @return
