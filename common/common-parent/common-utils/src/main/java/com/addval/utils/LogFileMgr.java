//Source file: C:\\users\\prasad\\projects\\common\\src\\client\\source\\com\\addval\\utils\\LogFileMgr.java
...
//Source file: C:\\Projects\\Common\\src\\client\\source\\com\\addval\\utils\\LogFileMgr.java
...
/**
 * 08/06/2001 - This class has been changed to work with Log4J.
 * Generic class to manage project logs.  Normally a single instance of this class
 * is
 * created during the startup (singleton).
 * Program can use one of the many "log<Type>" methods to
 * log information. For example to log an error the user could
 * use "logError()" method.
 *
 * The amount and type of log can be controlled by setting up parameters in a
 * configration file.  The parameters can be
...
public final class LogFileMgr
{
	...
	/**
	 * This was causing re-configuration of log4j, resulting in errors such as "attempted to append to closed Appender".
	 * Replace with new standard call to LogMgr.
	 */
	...
	/**
	 * @deprecated
	 * This method has been deprecated. Use the method without the "source" parameter
	 *
	 * Logs error mesasage
	 * @param source String. Origin class/Id
	 * @param message String
	 * @exception
	 * @roseuid 378A860D01A1
	 */
	 ...
	 * Logs error mesasage
	 * @param source String. Origin  class/Id
	 * @param excep Exception. The message in the exception
	 * logged. A strack trace of the excpetion is also logged..
	 * @exception
	 * @roseuid 379D166E0280
	 */
	 ...
	 * @deprecated
	 * This method has been deprecated. Use the method without the "source" parameter.
	 * Logs SQL message. All SQL statements excuted on the database server will be
	 * logged here
	 * @param source String. Origin class/ID
	 * @param message String
	 * @exceptio
	...
	/**
	 * Logs traceEnter/traceExit. These are put at the top and bottom of  methods to
	 * track the current location of the program execution.
	 * Good for debugging.
	 * @param source String. Origin class/ID
	 * @param message String
	 * @exception
	 * @see LogFileMgr#traceEnter traceEnter
	 ...
	 * location of the program execution.
	 * Good for debugging.
	 * @param source String. Origin class/ID
	 * @param message String
	 * @exception
	...
	/**
	 * Logs traceExit. These are put at the bottom of methods to track the current
	 * location of the program execution.
	 * Good for debugging.
	 * @param source String. Origin class/ID
	 * @param message String
	...
	/**
	 * Logs all types of message. Instead of calling a specific log message type (such
	 * as logError, logInfo, et.,) we could call this an pass a message type.
	 * @param msgType int. Can be ERROR, INFO, etc.,
	 * @param source - String. Origin class/Id
	 * @param message String
	 * @exception
	 * @roseuid 377A9566002E
	 */
	public void logMsg(int msgType, String source, String message)
	{
        ...
        switch ( msgType ) {
            ...
            case LogFileMgr._ERROR   :  logError    ( source, message ); break;

            case LogFileMgr._WARNING :  logWarning  ( source, message ); break;

            case LogFileMgr._INFO    :  logInfo     ( source, message ); break;

            case LogFileMgr._SQL     :  logSql      ( source, message ); break;

            case LogFileMgr._TRACE   :  logTrace    ( source, message ); break;
	...
	{
		if(excep == null)_logger.error("null");
		else _logger.error(excep.getMessage(), excep);
	}
