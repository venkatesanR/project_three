...
public class Duration implements java.io.Serializable
{
	...
	{
		if(_startDt == null || _endDt == null)return 0;
	...
	public boolean equals(Object obj)
	{
		...
		if(obj == null || !(obj instanceof com.addval.utils.Duration) )return false;
				
		Duration other = (Duration)obj;
		if(GenUtl.equals(this._startDt, other._startDt) &&
			GenUtl.equals(this._endDt, other._endDt))return true;
	...
	{
		int hashCode = 0;
		if(_startDt != null) hashCode = 31 * _startDt.hashCode();
		if(_endDt != null) hashCode +=  _endDt.hashCode();
