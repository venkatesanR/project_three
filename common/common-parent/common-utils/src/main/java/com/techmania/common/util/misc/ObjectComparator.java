...
public class ObjectComparator implements java.util.Comparator, java.io.Serializable {
    private String _module = "com.techmania.common.util.misc";
    ...
    public int compare(Object o1, Object o2) {
        try {
            ...
            throw new XRuntime(_module,
                    "Error while performing sorting: Check whether the method \"" + getMethodName() + "()\"\'s return" +
                            " " +
                            "type implements java.lang.Comparable \n" + ccexc.toString());
        } catch (NoSuchMethodException nsmexc) {
            throw new XRuntime(_module,
                    "Error while performing sorting: Check whether the method \"" + getMethodName() + "\" is valid " +
                            "and exist\n" + nsmexc.toString());
        } catch (IllegalAccessException iaexc) {
            throw new XRuntime(_module,
                    "Error while performing sorting: Check whether the method \"" + getMethodName() + "\" is PUBLIC" +
                            ".\n" + iaexc.toString());
        } catch (IllegalArgumentException iargexc) {
            throw new XRuntime(_module,
                    "Error while performing sorting: Ensure whether the method \"" + getMethodName() + "\" has NO " +
                            "arguments\n" + iargexc.toString());
        } catch (Exception exc) {
