//Source file: C:\\projects\\common\\src\\client\\source\\com\\addval\\utils\\StrUtl.java
...
public class StrUtl {
	...
	/**
	 * compares two strings including nulls and returns true if they are the same including the case
	 *
	 * @param str1
	 * @param str2
	 * @return boolean
	...
	/**
	 * compares two strings including nulls and returns true if they are the same ignoring the case
	 *
	 * @param str1
	 * @param str2
	 * @return boolean
	...
	/**
	 * Returns a list of tokens (trimmed) derived from the input string. Uses separators as delimiting characters but separators are not returned as tokens. If separators is null or empty then , is used as a delimiter Could return an empty list but never a null
	 * 
	 * @param String
	 ...
	 *            String to truncate
	 * @param length
	 *            max string length of the truncated string. Must >= 0. If < 0 considered as 0
	 */
