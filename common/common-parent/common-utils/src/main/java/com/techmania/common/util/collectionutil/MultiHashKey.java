 ...
 * @author ravi
 */
public class MultiHashKey implements Serializable {
    ...
    public MultiHashKey(List partKeys) {
        if (com.techmania.common.util.misc.GenUtl.listIsEmpty(partKeys)) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof MultiHashKey)) {
            return false;
        }
        ...
        for (int i = 0; i < _size; i++) {
            if (!GenUtl.equals(this._partKeys.get(i), other._partKeys.get(i))) {
                return false;
            }
        }
