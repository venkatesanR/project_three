 ...
 */
package com.addval.utils.externalcache;
...
/**
 * A simple Ehcache based external cache. Configure this as a spring bean and specify the
 * bean name in OkudTree configuration xml.
 * 
...
{               
    ...
    {       
        ...
        if(url == null)url = this.getClass().getResource(cacheConfigFile);
        return url;      
    }    
