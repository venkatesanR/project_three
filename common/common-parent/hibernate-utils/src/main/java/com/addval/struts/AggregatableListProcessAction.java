...
public class AggregatableListProcessAction extends BaseAction
{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest req, HttpServletResponse res) throws Exception
	{
		...
		try{
			...
			EJBResultSet ejbrs = tableManagerRemote.lookup(sql.toString(), listForm.getMetadata());
			...
			Environment.getInstance(subsystem).getLogFileMgr(getClass().getName()).logError("Error looking up data in AggregatableListProcessAction");
			Environment.getInstance(subsystem).getLogFileMgr(getClass().getName()).logError(e);
