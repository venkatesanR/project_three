...
public class ParserUtils
{
    ...
    public static  HashMap convertBean2Hash(Object bean, HashMap hash) throws Exception
	{
...
//				System.out.println( " is *********\n" + name + "\t" + PropertyUtils.getSimpleProperty( bean, name ) );
	...
	// friendly method to prepare <code>DynaBeans</code> from a <code>ResultSet</code>
	// saves the usage of a data holder object
	public static DynaBean[] getDynaBeans(ResultSet rs, java.util.Properties props) throws Exception
	{
		return getDynaBeans( rs, props );
	}
	...
	public static Object[] getBeans(ResultSet rs, Object bean, java.util.Properties props) throws Exception
	{
		//if (mappingFileName.endsWith( ".properties" ))
		//	mappingFileName = mappingFileName.substring( 0, mappingFileName.indexOf( ".properties" ));
		return getBeans( rs, bean, props );
	}
