 ...
 */
public class SQLServerSQLExceptionTranslator extends SQLExceptionTranslator
{
	private static final String _ERROR_PATTERN = "(with index|constraint|with unique index| for object| into column) '([A-Za-z0-9_]*)'";

	/**
	 * @param errorMessages
	 * @roseuid 3EBC542300CB
	 */
	public SQLServerSQLExceptionTranslator()
	{
